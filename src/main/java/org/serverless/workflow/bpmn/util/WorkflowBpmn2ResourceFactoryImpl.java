...
public class WorkflowBpmn2ResourceFactoryImpl extends ResourceFactoryImpl {
     ...
     * <!-- end-user-doc -->
     */
    public WorkflowBpmn2ResourceFactoryImpl() {
        super();
    }
    ...
    public Resource createResource(URI uri) {
        ...
        WorkflowBpmn2ResourceImpl result = new WorkflowBpmn2ResourceImpl(uri);
